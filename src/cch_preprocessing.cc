...
//     // find neighbor with lowest higher rank and add to the elimination tree
//     auto const& next_node_ = find_smallest_neighbor(neighbors_);
//     elimination_tree_[rank] = next_node_;
//   }
// }